...
@Component({
  selector: 'app-user-registeredtoday',
  templateUrl: './user-registeredtoday.component.html',
  styleUrls: ['./user-registeredtoday.component.scss']
})
export class UserRegisteredtodayComponent implements OnInit {
  ...
  retrievAll(){
    this._coreConfigService.config.pipe(takeUntil(this._unsubscribeAll)).subscribe(config => {
      ...
      if (config.layout.animation === 'zoomIn') {
        setTimeout(() => {
          this.userService.getRegisteredToday(this.selectedPage,this.selectedOption,this.searchValue).pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
