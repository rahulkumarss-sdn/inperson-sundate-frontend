...
export class UserListComponent implements OnInit {
  ...
  retrievAll(){
    this._coreConfigService.config.pipe(takeUntil(this._unsubscribeAll)).subscribe(config => {
      ...
      if (config.layout.animation === 'zoomIn') {
        setTimeout(() => {
          this.userService.getAll(this.selectedPage,this.selectedOption,this.searchValue,this.selectedStatus).pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
  ...
  changeStatus(row) {
    ...
    console.log("row",row.isBlocked );
    this.userService.updateStatus(row._id,{isBlocked:row.isBlocked}).subscribe(res=>{})
